...
posture:
  - control: OPSEC-IDENTITY-101          # git identity == persona, != real
  - control: OPSEC-SECRET-050            # no secrets in the environment
  - control: OPSEC-SECRET-060            # forbidden plaintext secret files absent
    params: {{ forbidden_paths: ["~/.aws/credentials", "~/.netrc"] }}{egress}
  - control: OPSEC-DISK-001              # system volume encryption on
